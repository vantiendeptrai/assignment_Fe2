...
const ProductDetailPage = () => {
  ...
  return (
    ...
    <img src={product.images?.[1].base_url} alt="" />
    <img src={product.images?.[1].base_url} alt="" />
    <img src={product.images?.[1].base_url} alt="" />
    <img src={product.images?.[1].base_url} alt="" /> */}
        ...
        <div className="w-[1100px] mx-[160px]">
          ...
          <div>
            ...
            <span>
              ...
              và tinh tế. Samsung Galaxy A73 được thiết kế gọn nhẹ với tiêu chí
              đáp ứng khả năng mang theo để tiện đi lại cho người dùng. Giờ đây,
              bạn có thể mang theo chiếc smartphone bên cạnh đến bất cứ đâu, bất
              cứ lúc nào. Kích thước và trọng lượng của chiếc điện thoại rất vừa
              phải và dĩ nhiên sẽ không chiếm quá nhiều diện tích trong túi xách
              và có thể di chuyển dễ dàng.
            </span>
          </div>
